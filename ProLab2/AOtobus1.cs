...
namespace ProLab2
{
    public partial class AOtobus1 : Form
    {
        public AOtobus1()
        {
            InitializeComponent();
        ...
        Dictionary<string, Dictionary<string, int>> fiyatlar = new Dictionary<string, Dictionary<string, int>>
{
    ...
    { "Ankara", new Dictionary<string, int> { { "Istanbul", 300 }, { "Kocaeli", 400 } } },
        ...
        private void AOtobus1_Load(object sender, EventArgs e)
        {
            string a = "", b = "";
            ...
            baglanti.Open();
            SqlCommand komut1 = new SqlCommand("select * from AOtobus1", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut2 = new SqlCommand("select * from AOtobus1", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut3 = new SqlCommand("select * from AOtobus1", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut4 = new SqlCommand("select * from AOtobus1", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut5 = new SqlCommand("select * from AOtobus1", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut6 = new SqlCommand("select * from AOtobus1", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut7 = new SqlCommand("select * from AOtobus1", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut8 = new SqlCommand("select * from AOtobus1", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut9 = new SqlCommand("select * from AOtobus1", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut10 = new SqlCommand("select * from AOtobus1", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut11 = new SqlCommand("select * from AOtobus1", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut12 = new SqlCommand("select * from AOtobus1", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut13 = new SqlCommand("select * from AOtobus1", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut14 = new SqlCommand("select * from AOtobus1", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut15 = new SqlCommand("select * from AOtobus1", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut16 = new SqlCommand("select * from AOtobus1", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut17 = new SqlCommand("select * from AOtobus1", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut18 = new SqlCommand("select * from AOtobus1", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut19 = new SqlCommand("select * from AOtobus1", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut20 = new SqlCommand("select * from AOtobus1", baglanti);
        ...
        private void button26_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection baglanti = new SqlConnection(connectionString))
            {
                ...
                string ekle = "INSERT INTO AOtobus1 (Ad, Soyad, Cinsiyet, Tc, Mail, DogumTarih, KoltukNo, Ucret) VALUES (@Ad, @Soyad, @Cinsiyet, @Tc, @Mail, @DogumTarih, @KoltukNo, @Ucret)";
