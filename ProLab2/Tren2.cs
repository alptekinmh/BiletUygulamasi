...
namespace ProLab2
{
    public partial class Tren2 : Form
    {
        public Tren2()
        {
            InitializeComponent();
        ...
        private void Tren2_Load(object sender, EventArgs e)
        {
            string a = "", b = "";
            ...
            baglanti.Open();
            SqlCommand komut1 = new SqlCommand("select * from Tren2", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut2 = new SqlCommand("select * from Tren2", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut3 = new SqlCommand("select * from Tren2", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut4 = new SqlCommand("select * from Tren2", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut5 = new SqlCommand("select * from Tren2", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut6 = new SqlCommand("select * from Tren2", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut7 = new SqlCommand("select * from Tren2", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut8 = new SqlCommand("select * from Tren2", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut9 = new SqlCommand("select * from Tren2", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut10 = new SqlCommand("select * from Tren2", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut11 = new SqlCommand("select * from Tren2", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut12 = new SqlCommand("select * from Tren2", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut13 = new SqlCommand("select * from Tren2", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut14 = new SqlCommand("select * from Tren2", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut15 = new SqlCommand("select * from Tren2", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut16 = new SqlCommand("select * from Tren2", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut17 = new SqlCommand("select * from Tren2", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut18 = new SqlCommand("select * from Tren2", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut19 = new SqlCommand("select * from Tren2", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut20 = new SqlCommand("select * from Tren2", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut21 = new SqlCommand("select * from Tren2", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut22 = new SqlCommand("select * from Tren2", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut23 = new SqlCommand("select * from Tren2", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut24 = new SqlCommand("select * from Tren2", baglanti);
            ...
            baglanti.Open();
            SqlCommand komut25 = new SqlCommand("select * from Tren2", baglanti);
        ...
        private void button26_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection baglanti = new SqlConnection(connectionString))
            {
                ...
                string ekle = "INSERT INTO Tren2 (Ad, Soyad, Cinsiyet, Tc, Mail, DogumTarih, KoltukNo, Ucret) VALUES (@Ad, @Soyad, @Cinsiyet, @Tc, @Mail, @DogumTarih, @KoltukNo, @Ucret)";
                ...
                cmd.Parameters.AddWithValue("@KoltukNo", TxtKltkNo.Text);
